...
#include "XGEditorModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UXGEditorModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UXGEditorModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UXGEditorModeInteractiveTool* NewTool = NewObject<UXGEditorModeInteractiveTool>(SceneState.ToolManager);
...
UXGEditorModeInteractiveToolProperties::UXGEditorModeInteractiveToolProperties()
{
...
void UXGEditorModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UXGEditorModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UXGEditorModeInteractiveToolProperties>(this, "Measurement");
...
void UXGEditorModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UXGEditorModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UXGEditorModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UXGEditorModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UXGEditorModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UXGEditorModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UXGEditorModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UXGEditorModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UXGEditorModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
