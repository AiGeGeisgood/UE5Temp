...
#include "XGEditorModeInteractiveTool.generated.h"


/**
 * Builder for UXGEditorModeInteractiveTool
 */
UCLASS()
class XGEDITORMODE_API UXGEditorModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UXGEditorModeInteractiveTool
 */
UCLASS(Transient)
class XGEDITORMODE_API UXGEditorModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UXGEditorModeInteractiveToolProperties();
...
/**
 * UXGEditorModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class XGEDITORMODE_API UXGEditorModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UXGEditorModeInteractiveToolProperties> Properties;
