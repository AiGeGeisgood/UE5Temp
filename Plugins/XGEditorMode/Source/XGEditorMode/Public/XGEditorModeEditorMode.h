...
#include "XGEditorModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UXGEditorModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_XGEditorModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UXGEditorModeEditorMode();
	virtual ~UXGEditorModeEditorMode();
